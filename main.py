...
def main():
    """Start the bot"""
    # Get token from environment or use the provided one
    token = os.getenv('TELEGRAM_BOT_TOKEN', '8251732768:AAGCiep_G35cu1wwmYxqDj0lYzMI2bpN394')
